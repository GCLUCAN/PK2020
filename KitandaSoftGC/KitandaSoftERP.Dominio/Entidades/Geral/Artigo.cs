...
{
    public class Artigo : Retorno.Retorno
    {
        ...
        public Artigo(int pCodigo)
        {
            Codigo = pCodigo;
        }
        public Artigo(int pCodigo, string pProductDesignation)
        {
            Codigo = pCodigo;
    ...
    public class StockInfoDTO : Retorno.Retorno
    {
    ...
    public class DimensaoDTO : Artigo
    {
        public int ProductID { get; set; }
        public int CorID { get; set; }
        public int TamanhoID { get; set; }
    }
    public class ComposicaoDTO : Artigo
    {
        public int ArtigoVirtualID { get; set; }
        public decimal Percentual { get; set; }
    }
    public class SemelhanteDTO : Artigo
    {
        public int ProductID { get; set; }
    }
    public class LoteDTO : Artigo
    {
        public LoteDTO()
        {
        }
    ...
    public class NumeroSerieDTO : Artigo
    {
        public int ProductID { get; set; }
    }
    public class ProductPriceListDTO : Artigo
    {
    ...
    public class ProductPrinterDTO : Retorno.Retorno
    {
        public int ProductID { get; set; }
