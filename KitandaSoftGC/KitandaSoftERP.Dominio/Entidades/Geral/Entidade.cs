...
{
    public class Entidade : Retorno.Retorno
    {
        ...
        public List<Entidade> AssociedEntities { get; set; }
        ...
        public Entidade(int pCodigo)
        {
            Codigo = pCodigo;
        }

        public Entidade(int pCodigo, string pNome)
        {
            Codigo = pCodigo;
            NomeCompleto = pNome;
        }

        public Entidade(string pNome)
        {
            NomeCompleto = pNome;
        }

        public Entidade(string pNome, string pFilial)
        {
            NomeCompleto = pNome;
            Filial = pFilial;
        }
