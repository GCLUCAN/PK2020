...
{
    public class AtendimentoItem: Retorno.Retorno
    {
        ...
        public AtendimentoItem(int pCodigo)
        {
            Codigo = pCodigo;
            Atendimento = -1;
            Artigo = -1;
        ...
        public AtendimentoItem(int pCodigo, int pAtendimento, int pProduto, decimal pQuantidade, decimal pPreco, decimal pTotal, string pUtilizador, DateTime pDataLancamento, string pFilial)
        {
            Codigo = pCodigo;
