...
{
    public class OrdemServico : Retorno.Retorno
    {
        public OrdemServico()
        {
        ...
        public OrdemServico(int pOrdeID)
        {
            WorkOrderID = pOrdeID;
        }
    ...
    public class CheckListDTO : Retorno.Retorno
    {
        public CheckListDTO()
        {
    ...
    public class OrderDetailDTO : Retorno.Retorno
    {
    ...
    public class IncidentDTO : Retorno.Retorno
    {
        public int OrderServiceID { get; set; }
    ...
    public class NoteDTO : Retorno.Retorno
    {
        public int OrderServiceID { get; set; }
