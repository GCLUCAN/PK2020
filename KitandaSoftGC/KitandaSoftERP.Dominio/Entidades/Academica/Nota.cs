...
{
    public class Nota : Retorno.Retorno
    {
        ...
        public Nota(int pMatricula, string pTurma, string pDisciplina, string pInscricao, string pNome)
        {
        ...
        public Nota(string pDisciplina, string pTurma, int pMatricula, int pAno, string pFilial, string pAvaliacao)
        {
            Matricula = pMatricula;
            Turma = pTurma;
            Disciplina = pDisciplina;
        ...
        public Nota(int pMatricula, int pAno, string pFilial)
        {
            Matricula = pMatricula;
            AnoLectivo = pAno;
            CompanyID = pFilial;
        ...
        public Nota(int pMatricula, int pDisciplina, int pAno, decimal pNota)
        {
            Matricula = pMatricula;
